...
Donghyun Sohn, Kelly Jiang, Jennie Rogers

{donghyun.sohn@u.,kellyjiang2022@u., jennie@}northwestern.edu
...
Configure psql and load TPC-H 600, 1200, 2400 databases
...
--unioned_db=tpch_unioned_600
--alice_db=tpch_alice_600
--bob_db=tpch_bob_600
```
Make Alchemy tests:
```
...
--unioned_db=tpch_unioned_600 or tpch_unioned_1200 or tpch_unioned_2400
--alice_db=tpch_alice_600 or tpch_alice_1200 or tpch_alice_2400
--bob_db=tpch_bob_600 or tpch_bob_1200 or tpch_bob_12400
```
