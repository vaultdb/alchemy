...
public class StateIdentifier implements StatementVisitor<StateMachine> {
	...
	@Override
	public StateMachine visit(ASTSetNonNullArrayEntriesStatement stmt) {
		return buildOne(stmt);
	}

	@Override
	public StateMachine visit(ASTWriteArrayStatement stmt) {
		return buildOne(stmt);
	}

	@Override
	public StateMachine visit(ASTReadArrayStatement stmt) {
		return buildOne(stmt);
	}
