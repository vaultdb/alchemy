...
//				throw new RuntimeException("Bits doesn't match! "+left+"\t"+right);
	...
	@Override
	public Void visit(ASTSetNonNullArrayEntriesStatement stmt) {
		visit(stmt.expr);
		return null;
	}

	@Override
	public Void visit(ASTGetNonNullArrayEntriesStatement stmt) {
		visit(stmt.expr);
		return null;
	}

	@Override
	public Void visit(ASTWriteArrayStatement stmt) {
		visit(stmt.array);
		return null;
	}

	@Override
	public Void visit(ASTReadArrayStatement stmt) {
		visit(stmt.array);
		return null;
	}
}
