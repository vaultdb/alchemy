...
public abstract interface StatementVisitor<T> {
	...
	public abstract T visit(ASTSetNonNullArrayEntriesStatement stmt);

	public abstract T visit(ASTGetNonNullArrayEntriesStatement stmt);
	
	public abstract T visit(ASTWriteArrayStatement stmt);
