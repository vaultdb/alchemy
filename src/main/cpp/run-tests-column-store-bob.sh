...
./bin/secure_plan_deparser_test --flagfile=flagfiles/bob.flags --storage=column --alice_host=$ALICE_HOST
./bin/secure_tpch_test  --flagfile=flagfiles/bob.flags --storage=column --alice_host=$ALICE_HOST
./bin/full_optimized_test --flagfile=flagfiles/bob.flags --storage=column --alice_host=$ALICE_HOST
