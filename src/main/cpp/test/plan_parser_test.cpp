...
TEST_F(PlanParserTest, tpch_q3) {
    ...
    std::string expected_plan = "#8: Project<bool> ((<0, $0 int32>, <1, $3 float>, <2, $1 int64>, <3, $2 int32>)) : (#0 int32 lineitem.l_orderkey, #1 float .revenue, #2 int64 .o_orderdate, #3 int32 orders.o_shippriority) order by: {<-1, ASC> , <1, DESC> , <2, ASC> )\n"
                                ...
                                "                            #0: SqlInput<bool> (\"SELECT * FROM (SELECT c_custkey, c_mktsegment, NOT c_mktsegment = 'HOUSEHOLD ' AS dummy_tag FROM customer ORDER BY c_custkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 customer.c_custkey, #1 varchar(10) customer.c_mktsegment) order by: {<0, ASC> ) tuple count: 10\n"
...
TEST_F(PlanParserTest, tpch_q5) {
    ...
    std::string expected_plan = "#9: Sort<bool> ({<1, DESC> )) : (#0 varchar(25) nation.n_name, #1 float .revenue) order by: {<1, DESC> )\n"
                                ...
                                "                            #1: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderkey, o_custkey, o_orderdate FROM orders ORDER BY o_orderkey, o_custkey, o_orderdate ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 int64 .o_orderdate) order by: {<0, ASC> , <1, ASC> , <2, ASC> ) tuple count: 10\n"
...
TEST_F(PlanParserTest, tpch_q8) {
    ...
    std::string expected_plan = "#10: Project<bool> ((<0, $0 int32>, <1, $1 / $2 float>)) : (#0 int32 orders.o_year, #1 float .anonymous) order by: {<0, ASC> )\n"
                                ...
                                "                            #0: SqlInput<bool> (\"SELECT * FROM (SELECT c_nationkey, c_custkey FROM customer c JOIN nation n1 ON c_nationkey = n_nationkey                 JOIN region ON r_regionkey = n_regionkey WHERE r_name = 'MIDDLE EAST' ORDER BY c_custkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 customer.c_nationkey, #1 int32 customer.c_custkey) order by: {<1, ASC> ) tuple count: 10\n"
                                "                            #1: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderkey, o_custkey, o_orderyear::INT AS o_year FROM orders ORDER BY o_custkey, o_orderkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 int32 orders.o_year) order by: {<1, ASC> , <0, ASC> ) tuple count: 10\n"
                                ...
                                "                            #4: SqlInput<bool> (\"SELECT * FROM (SELECT s_suppkey, CASE WHEN n_name = 'EGYPT' THEN 1.0 ELSE 0.0 END AS nation_check FROM supplier JOIN nation ON n_nationkey = s_nationkey ORDER BY s_suppkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 supplier.s_suppkey, #1 float .nation_check) order by: {<0, ASC> ) tuple count: 10\n";
...
TEST_F(PlanParserTest, tpch_q9) {
    ...
    std::string expected_plan = "#7: Sort<bool> ({<0, ASC> , <1, DESC> )) : (#0 varchar(25) nation.n_name, #1 int32 orders.o_year, #2 float .sum_profit) order by: {<0, ASC> , <1, DESC> )\n"
                                ...
                                "                    #3: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderyear AS o_year, o_orderkey FROM orders ORDER BY o_orderkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_year, #1 int32 orders.o_orderkey) order by: {<1, ASC> ) tuple count: 10\n";
...
TEST_F(PlanParserTest, tpch_q18) {
    ...
    std::string expected_plan = "#13: Sort<bool> ({<-1, ASC> , <4, DESC> , <3, ASC> )) : (#0 varchar(25) customer.c_name, #1 int32 customer.c_custkey, #2 int32 orders.o_orderkey, #3 int64 .o_orderdate, #4 float orders.o_totalprice, #5 float .sum_qty) order by: {<-1, ASC> , <4, DESC> , <3, ASC> )\n"
                                ...
                                "                        #7: SqlInput<bool> (\"SELECT * FROM (SELECT l_orderkey, l_quantity FROM lineitem ORDER BY l_orderkey, l_quantity ) input LIMIT 10\", tuple_count=10) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity) order by: {<0, ASC> , <1, ASC> ) tuple count: 10\n"
                                ...
                                "                                #1: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderkey, o_custkey, o_totalprice, o_orderdate FROM orders ORDER BY o_orderkey, o_custkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 float orders.o_totalprice, #3 int64 .o_orderdate) order by: {<0, ASC> , <1, ASC> ) tuple count: 10\n"
                                ...
                                "                                            #0: SqlInput<bool> (\"SELECT * FROM (SELECT l_orderkey, l_quantity FROM lineitem ORDER BY l_orderkey, l_quantity ) input LIMIT 10\", tuple_count=10) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity) order by: {<0, ASC> , <1, ASC> ) tuple count: 10\n"
                                "                    #9: SqlInput<bool> (\"SELECT * FROM (SELECT c_custkey, c_name FROM customer ORDER BY c_custkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 customer.c_custkey, #1 varchar(25) customer.c_name) order by: {<0, ASC> ) tuple count: 10\n";
