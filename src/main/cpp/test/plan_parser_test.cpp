...
TEST_F(PlanParserTest, tpch_q03) {
    ...
    SortDefinition expected_sort{ColumnSort(-1, SortDirection::ASCENDING),
           ...
           string expected_plan = "#9: Project<bool> ((<0, $0 int32>, <1, $3 float>, <2, $1 int64>, <3, $2 int32>)) : (#0 int32 orders.l_orderkey, #1 float revenue, #2 int64 orders.o_orderdate, #3 int32 orders.o_shippriority) order by: {<1, DESC> , <2, ASC> }\n"
                                  "    #8: Sort<bool> ({<3, DESC> , <1, ASC> }) : (#0 int32 orders.o_orderkey, #1 int64 orders.o_orderdate, #2 int32 orders.o_shippriority, #3 float revenue) order by: {<3, DESC> , <1, ASC> }\n"
                                  ...
                                  "                    #5: KeyedJoin<bool> ($0 == $3) : (#0 int32 orders.o_orderkey, #1 int64 orders.o_orderdate, #2 int32 orders.o_shippriority, #3 int32 lineitem.l_orderkey, #4 float revenue) order by: {<3, ASC> , <0, ASC> , <1, ASC> , <2, ASC> }\n"
                                  ...
                                  "                            #2: KeyedJoin<bool> ($1 == $4) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 int64 orders.o_orderdate, #3 int32 orders.o_shippriority, #4 int32 customer.c_custkey) order by: {<0, ASC> , <2, ASC> , <3, ASC> , <4, ASC> }\n"
...
"                #8: KeyedJoin<bool> (($1 == $5) AND ($2 == $4)) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_nationkey, #2 int32 lineitem.l_suppkey, #3 float revenue, #4 int32 supplier.s_suppkey, #5 int32 supplier.s_nationkey) order by: {<4, ASC> }\n"
...
"                        #5: KeyedJoin<bool> ($2 == $3) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_nationkey, #2 int32 orders.o_orderkey, #3 int32 lineitem.l_orderkey, #4 int32 lineitem.l_suppkey, #5 float revenue) order by: {<3, ASC> , <4, ASC> , <5, ASC> , <2, ASC> }\n"
...
"                                #2: KeyedJoin<bool> ($1 == $4) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_custkey, #2 int32 customer.c_nationkey, #3 int32 orders.o_orderkey, #4 int32 orders.o_custkey) order by: {<3, ASC> , <4, ASC> , <1, ASC> }\n"
...
TEST_F(PlanParserTest, tpch_q08) {
    ...
    std::string expected_plan = "#11: Project<bool> ((<0, $0 int32>, <1, $2 / $1 float>)) : (#0 int32 orders.o_year, #1 float mkt_share) order by: {<0, ASC> }\n"
        ...
        "                #8: KeyedJoin<bool> ($0 == $2) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_year, #2 int32 lineitem.l_orderkey, #3 float volume, #4 float selected_volume) order by: {<2, ASC> , <1, ASC> , <0, ASC> }\n"
        ...
        "                        #6: KeyedJoin<bool> ($3 == $1) : (#0 int32 lineitem.l_orderkey, #1 int32 lineitem.l_suppkey, #2 float volume, #3 int32 supplier.s_suppkey, #4 bool nation_check) order by: {<0, ASC> , <3, ASC> }\n"
...
"                #8: KeyedJoin<bool> ($2 == $7) : (#0 varchar(25) nation.nation, #1 float partsupp.ps_supplycost, #2 int32 lineitem.l_orderkey, #3 float lineitem.l_extendedprice, #4 float lineitem.l_discount, #5 float l_quantity, #6 int32 o_year, #7 int32 orders.o_orderkey) order by: {<2, ASC> , <7, ASC> }\n"
...
"                        #5: KeyedJoin<bool> (($2 == $6) AND ($1 == $5)) : (#0 varchar(25) nation.nation, #1 int32 partsupp.ps_partkey, #2 int32 partsupp.ps_suppkey, #3 float partsupp.ps_supplycost, #4 int32 lineitem.l_orderkey, #5 int32 lineitem.l_partkey, #6 int32 lineitem.l_suppkey, #7 float l_quantity, #8 float lineitem.l_extendedprice, #9 float lineitem.l_discount) order by: {<4, ASC> , <5, ASC> , <6, ASC> , <2, ASC> , <3, ASC> , <0, ASC> }\n"
"                            #3: Project<bool> ((<0, $1 varchar>, <1, $2 int32>, <2, $3 int32>, <3, $4 float>)) : (#0 varchar(25) nation.nation, #1 int32 partsupp.ps_partkey, #2 int32 partsupp.ps_suppkey, #3 float partsupp.ps_supplycost) order by: {<2, ASC> , <3, ASC> , <0, ASC> }\n"
"                                #2: KeyedJoin<bool> ($0 == $3) : (#0 int32 supplier.s_suppkey, #1 varchar(25) nation.n_name, #2 int32 partsupp.ps_partkey, #3 int32 partsupp.ps_suppkey, #4 float partsupp.ps_supplycost) order by: {<3, ASC> , <4, ASC> , <1, ASC> , <0, ASC> }\n"
...
"    #13: GroupByAggregate<bool> (group-by: (0, 1, 2, 3, 4) aggs: (SUM($5) sum_qty)) : (#0 varchar(25) customer.c_name, #1 int32 customer.c_custkey, #2 int32 orders.o_orderkey, #3 int64 orders.o_orderdate, #4 float orders.o_totalprice, #5 float sum_qty) order by: {<0, ASC> , <1, ASC> , <2, ASC> , <3, ASC> , <4, ASC> }\n"
                                ...
                                "            #12: Project<bool> ((<0, $6 varchar>, <1, $5 int32>, <2, $0 int32>, <3, $3 int64>, <4, $2 float>, <5, $4 float>)) : (#0 varchar(25) customer.c_name, #1 int32 customer.c_custkey, #2 int32 orders.o_orderkey, #3 int64 orders.o_orderdate, #4 float orders.o_totalprice, #5 float lineitem.l_quantity) order by: {<5, ASC> , <1, ASC> }\n"
                                "                #11: KeyedJoin<bool> ($1 == $5) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 float orders.o_totalprice, #3 int64 orders.o_orderdate, #4 float lineitem.l_quantity, #5 int32 customer.c_custkey, #6 varchar(25) customer.c_name) order by: {<4, ASC> , <5, ASC> }\n"
                                ...
                                "                        #8: KeyedJoin<bool> ($0 == $2) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity, #2 int32 orders.o_orderkey, #3 int32 orders.o_custkey, #4 float orders.o_totalprice, #5 int64 orders.o_orderdate) order by: {<1, ASC> , <0, ASC> , <2, ASC> , <3, ASC> }\n"
                                "                            #6: Project<bool> ((<0, $0 int32>, <1, $1 float>)) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity) order by: {<1, ASC> , <0, ASC> }\n"
                                "                                #5: KeyedJoin<bool> ($0 == $2) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity, #2 int32 lineitem.l_orderkey) order by: {<1, ASC> , <0, ASC> , <2, ASC> }\n"
