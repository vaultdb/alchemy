...
TEST_F(PlanParserTest, tpch_q03) {
    ...
    SortDefinition expected_sort{ColumnSort(-1, SortDirection::ASCENDING),
           ...
           string expected_plan = "#9: Project<bool> ((<0, $0 int32>, <1, $3 float>, <2, $1 int64>, <3, $2 int32>)) : (#0 int32 orders.o_orderkey, #1 float .revenue, #2 int64 orders.o_orderdate, #3 int32 orders.o_shippriority) order by: {<-1, ASC> , <1, DESC> , <2, ASC> }\n"
                                ...
                                "        #7: GroupByAggregate<bool> (group-by: (0, 1, 2) aggs: (SUM($3) revenue)) : (#0 int32 orders.o_orderkey, #1 int64 orders.o_orderdate, #2 int32 orders.o_shippriority, #3 float .revenue) order by: {<0, ASC> , <1, ASC> , <2, ASC> }\n"
                                "            #6: Project<bool> ((<0, $0 int32>, <1, $1 int64>, <2, $2 int32>, <3, $4 float>)) : (#0 int32 orders.o_orderkey, #1 int64 orders.o_orderdate, #2 int32 orders.o_shippriority, #3 float .revenue) order by: {<0, ASC> , <1, ASC> , <2, ASC> }\n"
                                "                #5: SortMergeJoin<bool> ($0 == $3) : (#0 int32 orders.o_orderkey, #1 int64 orders.o_orderdate, #2 int32 orders.o_shippriority, #3 int32 lineitem.l_orderkey, #4 float .revenue) order by: {<0, ASC> , <1, ASC> , <2, ASC> }\n"
                                ...
                                "                        #2: SortMergeJoin<bool> ($1 == $4) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 int64 orders.o_orderdate, #3 int32 orders.o_shippriority, #4 int32 customer.c_custkey) order by: {<0, ASC> , <2, ASC> , <3, ASC> }\n"
...
TEST_F(PlanParserTest, tpch_q05) {
    ...
    std::string expected_plan = "#11: Sort<bool> ({<1, DESC> }) : (#0 varchar(25) nation.n_name, #1 float .revenue) order by: {<1, DESC> }\n"
                                ...
                                "                        #5: KeyedJoin<bool> ($2 == $3) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_nationkey, #2 int32 orders.o_orderkey, #3 int32 lineitem.l_orderkey, #4 int32 lineitem.l_suppkey, #5 float .revenue) order by: {}\n"
                                "                            #3: Project<bool> ((<0, $0 varchar>, <1, $2 int32>, <2, $3 int32>)) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_nationkey, #2 int32 orders.o_orderkey) order by: {}\n"
                                "                                #2: KeyedJoin<bool> ($1 == $4) : (#0 varchar(25) nation.n_name, #1 int32 customer.c_custkey, #2 int32 customer.c_nationkey, #3 int32 orders.o_orderkey, #4 int32 orders.o_custkey) order by: {<1, ASC> }\n"
                                ...
                                "                                    #1: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderkey, o_custkey, NOT (o_orderdate >= DATE '1993-01-01' AND o_orderdate < DATE '1994-01-01') AS dummy_tag FROM orders ORDER BY o_orderkey, o_custkey, o_orderdate ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey) order by: {<0, ASC> , <1, ASC> , <2, ASC> }\n"
...
TEST_F(PlanParserTest, tpch_q08) {
    ...
    std::string expected_plan = "#12: Sort<bool> ({<0, ASC> }) : (#0 int32 .o_year, #1 float .anonymous) order by: {<0, ASC> }\n"
                                "    #11: Project<bool> ((<0, $0 int32>, <1, $1 / $2 float>)) : (#0 int32 .o_year, #1 float .anonymous) order by: {<0, ASC> }\n"
                                "        #10: GroupByAggregate<bool> (group-by: (0) aggs: (SUM($1) null, SUM($2) null)) : (#0 int32 .o_year, #1 float .null, #2 float .null) order by: {<0, ASC> }\n"
                                "            #-1: Sort<bool> ({<0, ASC> }) : (#0 int32 .o_year, #1 float .anonymous, #2 float .volume) order by: {<0, ASC> }\n"
                                "                #9: Project<bool> ((<0, $0 int32>, <1, $4 * $2 float>, <2, $4 float>)) : (#0 int32 .o_year, #1 float .anonymous, #2 float .volume) order by: {}\n"
                                "                    #8: SortMergeJoin<bool> ($1 == $3) : (#0 int32 .o_year, #1 int32 orders.o_orderkey, #2 float .nation_check, #3 int32 lineitem.l_orderkey, #4 float .volume) order by: {}\n"
                                "                        #3: Project<bool> ((<0, $3 int32>, <1, $1 int32>)) : (#0 int32 .o_year, #1 int32 orders.o_orderkey) order by: {}\n"
                                "                            #2: SortMergeJoin<bool> ($0 == $2) : (#0 int32 customer.c_custkey, #1 int32 orders.o_orderkey, #2 int32 orders.o_custkey, #3 int32 .o_year) order by: {<0, ASC> }\n"
                                ...
                                "                                #1: SqlInput<bool> (\"SELECT * FROM (SELECT o_orderkey, o_custkey, EXTRACT('year' FROM o_orderdate)::INT AS o_year, NOT (o_orderdate >= date '1995-01-01' and o_orderdate < date '1996-12-31') dummy_tag FROM orders ORDER BY o_custkey, o_orderkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 int32 .o_year) order by: {<1, ASC> , <0, ASC> }\n"
                                "                        #7: Project<bool> ((<0, $1 float>, <1, $2 int32>, <2, $4 float>)) : (#0 float .nation_check, #1 int32 lineitem.l_orderkey, #2 float .volume) order by: {}\n"
                                "                            #6: SortMergeJoin<bool> ($0 == $3) : (#0 int32 supplier.s_suppkey, #1 float .nation_check, #2 int32 lineitem.l_orderkey, #3 int32 lineitem.l_suppkey, #4 float .volume) order by: {<0, ASC> }\n"
                                ...
                                "                                #5: SqlInput<bool> (\"SELECT * FROM (SELECT l_orderkey, l_suppkey, l_extendedprice * (1.0 - l_discount) volume FROM part JOIN lineitem ON p_partkey = l_partkey WHERE p_type = 'LARGE ANODIZED STEEL' ORDER BY l_orderkey ) input LIMIT 10\", tuple_count=10) : (#0 int32 lineitem.l_orderkey, #1 int32 lineitem.l_suppkey, #2 float .volume) order by: {<0, ASC> }\n";
...
TEST_F(PlanParserTest, tpch_q09) {
    ...
    std::string expected_plan = "#11: Sort<bool> ({<0, ASC> , <1, DESC> }) : (#0 varchar(25) nation.n_name, #1 int32 .o_year, #2 float .sum_profit) order by: {<0, ASC> , <1, DESC> }\n"
                                "    #10: GroupByAggregate<bool> (group-by: (0, 1) aggs: (SUM($2) sum_profit)) : (#0 varchar(25) nation.n_name, #1 int32 .o_year, #2 float .sum_profit) order by: {<0, ASC> , <1, ASC> }\n"
                                "        #-1: Sort<bool> ({<0, ASC> , <1, ASC> }) : (#0 varchar(25) nation.n_name, #1 int32 .o_year, #2 float .anonymous) order by: {<0, ASC> , <1, ASC> }\n"
                                "            #9: Project<bool> ((<0, $0 varchar>, <1, $6 int32>, <2, $3 * 1.000000 - $4 - $1 * $5 float>)) : (#0 varchar(25) nation.n_name, #1 int32 .o_year, #2 float .anonymous) order by: {<0, ASC> }\n"
                                "                #8: SortMergeJoin<bool> ($2 == $7) : (#0 varchar(25) nation.n_name, #1 float partsupp.ps_supplycost, #2 int32 lineitem.l_orderkey, #3 float lineitem.l_extendedprice, #4 float lineitem.l_discount, #5 float .l_quantity, #6 int32 .o_year, #7 int32 orders.o_orderkey) order by: {<0, ASC> }\n"
                                "                    #6: Project<bool> ((<0, $0 varchar>, <1, $3 float>, <2, $4 int32>, <3, $8 float>, <4, $9 float>, <5, $7 float>)) : (#0 varchar(25) nation.n_name, #1 float partsupp.ps_supplycost, #2 int32 lineitem.l_orderkey, #3 float lineitem.l_extendedprice, #4 float lineitem.l_discount, #5 float .l_quantity) order by: {<0, ASC> }\n"
                                "                        #5: SortMergeJoin<bool> ($2 == $6 AND $1 == $5) : (#0 varchar(25) nation.n_name, #1 int32 partsupp.ps_partkey, #2 int32 partsupp.ps_suppkey, #3 float partsupp.ps_supplycost, #4 int32 lineitem.l_orderkey, #5 int32 lineitem.l_partkey, #6 int32 lineitem.l_suppkey, #7 float .l_quantity, #8 float lineitem.l_extendedprice, #9 float lineitem.l_discount) order by: {<0, ASC> }\n"
                                "                            #3: Project<bool> ((<0, $1 varchar>, <1, $2 int32>, <2, $3 int32>, <3, $4 float>)) : (#0 varchar(25) nation.n_name, #1 int32 partsupp.ps_partkey, #2 int32 partsupp.ps_suppkey, #3 float partsupp.ps_supplycost) order by: {<0, ASC> }\n"
                                "                                #2: SortMergeJoin<bool> ($0 == $3) : (#0 int32 supplier.s_suppkey, #1 varchar(25) nation.n_name, #2 int32 partsupp.ps_partkey, #3 int32 partsupp.ps_suppkey, #4 float partsupp.ps_supplycost) order by: {<1, ASC> , <0, ASC> }\n"
...
TEST_F(PlanParserTest, tpch_q18) {
    ...
    std::string expected_plan = "#14: Sort<bool> ({<-1, ASC> , <4, DESC> , <3, ASC> }) : (#0 varchar(25) customer.c_name, #1 int32 customer.c_custkey, #2 int32 orders.o_orderkey, #3 int64 orders.o_orderdate, #4 float orders.o_totalprice, #5 float .sum_qty) order by: {<-1, ASC> , <4, DESC> , <3, ASC> }\n"
                                ...
                                "                #11: SortMergeJoin<bool> ($1 == $5) : (#0 int32 orders.o_orderkey, #1 int32 orders.o_custkey, #2 float orders.o_totalprice, #3 int64 orders.o_orderdate, #4 float lineitem.l_quantity, #5 int32 customer.c_custkey, #6 varchar(25) customer.c_name) order by: {<4, ASC> }\n"
                                ...
                                "                        #8: SortMergeJoin<bool> ($0 == $2) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity, #2 int32 orders.o_orderkey, #3 int32 orders.o_custkey, #4 float orders.o_totalprice, #5 int64 orders.o_orderdate) order by: {<1, ASC> , <0, ASC> }\n"
                                "                            #6: Project<bool> ((<0, $0 int32>, <1, $1 float>)) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity) order by: {<1, ASC> , <0, ASC> }\n"
                                "                                #5: SortMergeJoin<bool> ($0 == $2) : (#0 int32 lineitem.l_orderkey, #1 float lineitem.l_quantity, #2 int32 lineitem.l_orderkey) order by: {<1, ASC> , <0, ASC> }\n"
