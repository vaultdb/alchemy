...
void SortMergeAggregateTest::runTest(const string &expected_sql,
    ...
    SortMergeAggregate aggregate(input, groupByCols, aggregators, SortDefinition());
...
void SortMergeAggregateTest::runDummiesTest(const string &expected_sql,
                                          const vector<ScalarAggregateDefinition> &aggregators) const {
...
TEST_F(SortMergeAggregateTest, test_count) {
...
TEST_F(SortMergeAggregateTest, test_count_dummies) {
...
TEST_F(SortMergeAggregateTest, test_sum) {
...
TEST_F(SortMergeAggregateTest, test_sum_dummies) {
    std::string query = "SELECT l_orderkey, l_linenumber,  l_shipinstruct <> 'NONE' AS dummy  FROM lineitem WHERE l_orderkey <=" + std::to_string(FLAGS_cutoff) + " ORDER BY (1), (2)";
...
TEST_F(SortMergeAggregateTest, test_avg) {
...
TEST_F(SortMergeAggregateTest, test_avg_dummies) {
...
TEST_F(SortMergeAggregateTest, test_min) {
...
TEST_F(SortMergeAggregateTest, test_min_dummies) {
...
TEST_F(SortMergeAggregateTest, test_max) {
...
TEST_F(SortMergeAggregateTest, test_max_dummies) {
...
TEST_F(SortMergeAggregateTest, test_tpch_q1_sums) {
...
TEST_F(SortMergeAggregateTest, test_tpch_q1_avg_cnt) {
...
TEST_F(SortMergeAggregateTest, tpch_q1) {
