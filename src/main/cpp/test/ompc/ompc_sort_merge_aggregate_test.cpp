...
class OMPCSortMergeAggregateTest : public OmpcBaseTest {
...
void OMPCSortMergeAggregateTest::runTest(const string &expected_sql,
...
TEST_F(OMPCSortMergeAggregateTest, test_count) {
...
TEST_F(OMPCSortMergeAggregateTest, test_sum) {
...
TEST_F(OMPCSortMergeAggregateTest, test_avg) {
...
TEST_F(OMPCSortMergeAggregateTest, test_min) {
...
TEST_F(OMPCSortMergeAggregateTest, test_max) {
...
TEST_F(OMPCSortMergeAggregateTest, test_tpch_q1_sums) {
...
TEST_F(OMPCSortMergeAggregateTest, test_tpch_q1_avg_cnt) {
    ...
    SortMergeAggregate<emp::Bit> *aggregate = new SortMergeAggregate(lineitem_project, groupByCols, aggregators);
    aggregate->setOperatorId(-2);
    SecureTable *aggregated = aggregate->run();
...
TEST_F(OMPCSortMergeAggregateTest, tpch_q1) {
