...
const std::string ZkTest::unioned_db = "tpch_unioned_15000"; // rename from tpch_unioned_sf0.1 to avoid non-standard characters
const std::string ZkTest::alice_db = "tpch_unioned_15000";
