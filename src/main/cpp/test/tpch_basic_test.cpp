...
TEST_F(TpcHBasicTest, testQ1Truncated) {
 ...
 * "select\n"
                ...
                " limit 10"
 */
TEST_F(TpcHBasicTest, testQ3Truncated)  {
...
void TpcHBasicTest::validate_q3_join(const shared_ptr<PlainTable> &joined) {
...
TEST_F(TpcHBasicTest, testQ5Truncated)  {
