...
class AggregateCostModelTest : public EmpBaseTest {
...
/*
void
AggregateCostModelTest::runTest_SMA(const int &test_id, const string & test_name, const SortDefinition &expected_sort, const string &db_name) {
...
void
AggregateCostModelTest::runTest_NLA(const int &test_id, const string & test_name, const SortDefinition &expected_sort, const string &db_name) {
...
string
AggregateCostModelTest::generateExpectedOutputQuery(const int &test_id, const SortDefinition &expected_sort, const string &db_name) {
...
*/
void
AggregateCostModelTest::controlBitPacking(const string &db_name) {
    if(FLAGS_bitpacking == "packed") {
...
/*
TEST_F(AggregateCostModelTest, tpch_q3_SMA) {
    string unioned_db_name = "tpch_unioned_600";
    controlBitPacking(unioned_db_name);
    string local_db_name = (FLAGS_party == ALICE) ? "tpch_unioned_600" : "tpch_empty";
...
TEST_F(AggregateCostModelTest, tpch_q3_NLA) {
    string unioned_db_name = "tpch_unioned_600";
    controlBitPacking(unioned_db_name);
    string local_db_name = (FLAGS_party == ALICE) ? "tpch_unioned_600" : "tpch_empty";
...
TEST_F(AggregateCostModelTest, tpch_q8_SMA) {
...
TEST_F(AggregateCostModelTest, tpch_q8_NLA) {
...
TEST_F(AggregateCostModelTest, tpch_q18_SMA) {
    // -1 ASC, $4 DESC, $3 ASC
    SortDefinition expected_sort{ColumnSort(-1, SortDirection::ASCENDING),
...
TEST_F(AggregateCostModelTest, tpch_q18_NLA) {
    // -1 ASC, $4 DESC, $3 ASC
    SortDefinition expected_sort{ColumnSort(-1, SortDirection::ASCENDING),
                                 ColumnSort(4, SortDirection::DESCENDING),
                                 ColumnSort(3, SortDirection::ASCENDING)};
