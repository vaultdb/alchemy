...
class JoinCostComparisonTest : public EmpBaseTest {
protected:

    void runTest(const int &test_id, const string & test_name, const string & join_index, const SortDefinition &expected_sort, const string &db_name);
...
string
JoinCostComparisonTest::generateExpectedOutputQuery(const int &test_id, const SortDefinition &expected_sort, const string &db_name) {
