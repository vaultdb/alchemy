...
void SecureNestedLoopyAggregateTest::runTest(const string &expectedOutputQuery,
...
void SecureNestedLoopyAggregateTest::runDummiesTest(const string &expectedOutputQuery,
                                                const vector<ScalarAggregateDefinition> &aggregators) const {
