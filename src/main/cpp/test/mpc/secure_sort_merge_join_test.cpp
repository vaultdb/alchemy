...
TEST_F(SecureSortMergeJoinTest, test_tpch_q3_customer_orders) {
    ...
    cout << "LHS: " << orders_input->getOutput()->reveal()->toString(5, false) << endl;
    cout << "RHS: " << customer_input->getOutput()->reveal()->toString() << endl;
    cout << "lhs row cnt=" << orders_input->getOutput()->getTupleCount() << ", rhs=" << customer_input->getOutput()->getTupleCount() << '\n';
...
//TEST_F(SecureSortMergeJoinTest, test_tpch_q3_customer_orders_no_bit_packing) {
//
...
//
//
//TEST_F(SecureSortMergeJoinTest, test_tpch_q3_lineitem_orders_no_bit_packing) {
//
//    this->disableBitPacking();
//
//// get inputs from local oblivious ops
...
//            4);
//
//    auto co_join = new SortMergeJoin (orders_input, customer_input, customer_orders_predicate);
//
//    // join output schema:
...
//
//
//    auto col_join = new SortMergeJoin(lineitem_input, co_join, lineitem_orders_predicate);
//
//
...
//}
//
//TEST_F(SecureSortMergeJoinTest, test_tpch_q3_lineitem_orders_customer_no_bit_packing) {
//
//    this->disableBitPacking();
//    std::string expected_sql = "WITH orders_cte AS (" + orders_sql_ + "), \n"
//                                                                      "lineitem_cte AS (" + lineitem_sql_ + "), \n"
