...
class SecureBushyPlanEnumerationTest : public EmpBaseTest {
protected:
...
void
SecureBushyPlanEnumerationTest::runTest(const int &test_id, const SortDefinition &expected_sort) {
...
string
SecureBushyPlanEnumerationTest::generateExpectedOutputQuery(const int &test_id, const SortDefinition &expected_sort, const string &db_name) {
