...
std::shared_ptr<PlainTable> QueryTableTestQueries::getExpectedSecureOutput()  {
...
std::shared_ptr<PlainTable> QueryTableTestQueries::getExpectedSecureOutputDummyTag() {
