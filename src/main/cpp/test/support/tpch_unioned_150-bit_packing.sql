...
customer	c_custkey	1	150	150
customer	c_nationkey	0	24	25
customer	c_mktsegment	-1	-1	5
supplier	s_suppkey	1	10	10
supplier	s_name	-1	-1	10
supplier	s_nationkey	1	24	9
partsupp	ps_partkey	1	200	200
partsupp	ps_suppkey	1	10	10
...
orders	o_orderkey	1	5988	1500
orders	o_custkey	1	150	150
orders	o_orderstatus	-1	-1	3
orders	o_orderdate	8035	10591	2557
orders	o_orderpriority	-1	-1	5
orders	o_orderyear	1992	1998	7
lineitem	l_orderkey	1	5988	1500
lineitem	l_partkey	1	200	200
lineitem	l_suppkey	1	10	10
...
part	p_retailprice	901	1100	200
part	p_comment	-1	-1	200
