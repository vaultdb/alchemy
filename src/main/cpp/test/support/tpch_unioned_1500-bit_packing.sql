...
customer	c_custkey	1	1500	1500
customer	c_nationkey	0	24	25
customer	c_mktsegment	-1	-1	5
supplier	s_suppkey	1	100	100
supplier	s_name	-1	-1	100
supplier	s_nationkey	0	24	25
partsupp	ps_partkey	1	2000	2000
partsupp	ps_suppkey	1	100	100
...
orders	o_orderkey	1	60000	15000
orders	o_custkey	1	1500	1500
orders	o_orderstatus	-1	-1	3
orders	o_orderdate	8035	10591	2557
orders	o_orderpriority	-1	-1	5
orders	o_orderyear	1992	1998	7
lineitem	l_orderkey	1	60000	15000
lineitem	l_partkey	1	2000	2000
lineitem	l_suppkey	1	100	100
...
part	p_partkey	1	2000	2000
part	p_name	-1	-1	2000
part	p_mfgr	-1	-1	5
part	p_brand	-1	-1	25
part	p_type	-1	-1	150
part	p_size	1	50	50
part	p_container	-1	-1	40
part	p_retailprice	901	1901	1099
part	p_comment	-1	-1	1959
