...
public:
  ...
  CompareLessThanOrEqual(const Value &left, const Value &right) const = 0;

  [[nodiscard]] virtual Value CompareLessThan(const Value &left,
                                              const Value &right) const = 0;
  ...
  virtual void Swap(const Value &compareBit, Value &left, Value &right) = 0;
