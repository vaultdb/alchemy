...
if(EMP-TOOL_FOUND)
	set(EMP-TOOL_LIBRARIES ${EMP-TOOL_LIBRARY} ${OPENSSL_LIBRARIES}  ${GMP_LIBRARIES})
	set(EMP-ZK_LIBRARIES ${EMP-ZK_LIBRARY} ${OPENSSL_LIBRARIES}${GMP_LIBRARIES})
	set(EMP-TOOL_INCLUDE_DIRS ${EMP-TOOL_INCLUDE_DIR} ${OPENSSL_INCLUDE_DIR} ${GMP_INCLUDE_DIR})
endif()
