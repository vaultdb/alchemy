...
namespace vaultdb {
    ...
    public:
        ...
        BufferPoolManager &bpm_ = conf_.bpm_;
        int page_size_bits_ = conf_.bpm_.page_size_bytes_ / sizeof(Bit);
        ...
        auto new_ordinal_offsets = QueryTable<Bit>::getOrdinalOffsets(temp, this->tuple_cnt_);
        ...
        for (int i = 0; i < dummy_page_cnt; ++i) {
            ...
            auto page_ptr = bpm_.getPagePtr<Bit>(pid);
