...
namespace  vaultdb {
    ...
    protected:
        ...
        FieldType type_;
        int ordinal_;
        int field_size_bits_ = 0; // size in bits
    ...
    public:
        ...
        inline  size_t size() const {
            assert(field_size_bits_ > 0);  // if size == 0 then it is an invalid field
            return field_size_bits_;
        }
        ...
        void inline setSize(const int & size) { field_size_bits_ = size; }
