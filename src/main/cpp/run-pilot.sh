...
./bin/run_data_partner -h 127.0.0.1 -P 54321 --party=1 -d enrich_htn_unioned_alice --rp=pilot/secret_shares/tables/chi_partial_counts.alice --rc=pilot/test/output/chi-patient.alice -y all & 
./bin/run_data_partner -h 127.0.0.1 -P 54321 --party=2 -d enrich_htn_unioned_bob --rp=pilot/secret_shares/tables/chi_partial_counts.bob --rc=pilot/test/output/chi-patient.bob -y all
