...
./bin/run_data_partner -h 127.0.0.1 -P 54321 --party=1 -d enrich_htn_unioned_alice -p pilot/secret_shares/tables/chi_partial_counts.alice -r pilot/test/output/chi-patient-multisite.alice -y all -s &

./bin/run_data_partner -h 127.0.0.1 -P 54321 --party=2 -d enrich_htn_unioned_bob -p pilot/secret_shares/tables/chi_partial_counts.bob -r pilot/test/output/chi-patient-multisite.bob -y all -s
