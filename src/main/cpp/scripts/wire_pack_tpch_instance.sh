...
#usage: bash scripts/wire_pack_tpch_instance.sh <db name>
...
[ -d wires/temp ] || mkdir -p wires/temp
...
./bin/wire_pack_tpch_instance $DB_NAME wires/$DB_NAME 10086 | tee log/wire_pack_tpch_instance_p10086.log
