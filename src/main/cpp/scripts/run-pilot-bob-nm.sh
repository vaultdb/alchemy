...
#main test
./bin/run_data_partner 127.0.0.1 4444 2 pilot/test/input/bob-patient.csv pilot/test/output/chi-patient.bob
...
#./bin/run_data_partner -h  -P 4444 --party=2 -d enrich_htn_bob -p pilot/secret_shares/tables/chi_partial_counts.bob -r pilot/test/output/chi-patient-multisite.bob -y all -s

#echo "Assembling secret shares"
