...
public:
    explicit ExpressionNode(ExpressionNode<B> *lhs);
...
public:
    ...
    explicit PackedInputReference(const InputReference<B> & src)
...
public:
    explicit LiteralNode(const Field<B> & literal) : ExpressionNode<B>(nullptr), payload_(literal) {
