...
private:
    ...
    // int32_t debug_key_ = 5956; // debug key for filtering rows, set in setup()
    // GenericExpression<B> *debug_suspect_ = nullptr; // for filtering out rows to debug large datasets, configure this in setup()
