...
//    cout << "dummy : " << input_dummy << ", not_initialized_ : " << not_initialized_ << ", initialize ? " << to_initialize <<  ", input_field : " << input_field.toString() << ", output_field : " << output_field.toString() << "\n";
    ...
    not_initialized_ = not_initialized_ & !to_initialize;
