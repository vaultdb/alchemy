...
namespace vaultdb {
    ...
    public:
        BasicJoin(Operator<B> *lhs, Operator<B> *rhs, const BoolExpression<B> & predicate);
        BasicJoin(shared_ptr<QueryTable<B> > lhs, shared_ptr<QueryTable<B> > rhs, const BoolExpression<B> & predicate);
        ~BasicJoin() = default;
