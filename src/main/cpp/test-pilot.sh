...
./bin/run_data_partner 127.0.0.1 54321 1 pilot/input/alice-prod-patient.csv  pilot/secret_shares/chi-prod-patient.alice &
./bin/run_data_partner 127.0.0.1 54321 2 pilot/input/bob-prod-patient.csv  pilot/secret_shares/chi-prod-patient.bob
