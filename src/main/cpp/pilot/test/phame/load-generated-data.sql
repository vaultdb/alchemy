...
-- diabetes, htn, cerv, breast, lung, colorectal
...
\copy (SELECT patid, dx_diabetes, dx_hypertension, dx_cervical_cancer, dx_breast_cancer, dx_lung_cancer, dx_colorectal_cancer FROM phame_diagnosis WHERE site_id = 1) TO 'pilot/secret_shares/input/1/phame_diagnosis.csv' WITH DELIMITER ',';
...
\copy (SELECT patid, dx_diabetes, dx_hypertension, dx_cervical_cancer, dx_breast_cancer, dx_lung_cancer, dx_colorectal_cancer FROM phame_diagnosis WHERE site_id = 3) TO 'pilot/secret_shares/input/3/phame_diagnosis.csv' WITH DELIMITER ',';
