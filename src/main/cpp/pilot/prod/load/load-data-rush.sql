...
\copy (SELECT * FROM patient WHERE study_year=2018 ORDER BY pat_id, site_id) TO 'pilot/input/2018/rush.csv' CSV
\copy (SELECT * FROM patient WHERE study_year=2019 ORDER BY pat_id, site_id) TO 'pilot/input/2019/rush.csv' CSV
\copy (SELECT * FROM patient WHERE study_year=2020 ORDER BY pat_id, site_id) TO 'pilot/input/2020/rush.csv' CSV
