...
CREATE VIEW joined_labels AS (
    SELECT d.study_year, d.pat_id, d.site_id, d.age_stratum age_strata, d.sex, d.ethnicity, d.race, d.numerator demographics_numerator, p.numerator population_numerator, p.denom_excl
