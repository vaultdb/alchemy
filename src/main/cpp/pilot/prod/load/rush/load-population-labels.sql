...
\echo 'Loading 2018'
\copy population_labels(study_id, numerator, denom_excl) FROM 'pilot/input/rush/rumc_population_labels_2018.csv' CSV HEADER
ALTER TABLE population_labels ADD COLUMN study_year INT;
UPDATE population_labels SET study_year=2018;

\echo 'Loading 2019'
\copy population_labels(study_id, numerator, denom_excl) FROM 'pilot/input/rush/rumc_population_labels_2019.csv' CSV HEADER
UPDATE population_labels SET study_year=2019 WHERE study_year IS NULL;

\echo 'Loading 2020'
\copy population_labels(study_id, numerator, denom_excl) FROM 'pilot/input/rush/rumc_population_labels_2020.csv' CSV HEADER
