...
public class TpcHParseConstraintsTest  extends TpcHBaseTest {
    ...
    /**
     * check column definitions testing function to be used with testConstraintVisitorSchemaConstructor tests
     * @param tableName
     * @param customerConstraints
     * @param correctColumnDefinitions
     * @param toAssert boolean determining whether to check columnDefinitions are correct
     * @throws Exception
     */
    private void checkRelNodeColumnDefinitions(String tableName, List<RexNode> customerConstraints, List<ColumnDefinition> correctColumnDefinitions, boolean toAssert) throws Exception {
...
//		for (RexNode r: customerConstraints){
    ...
    public void testConstraintVisitorSchemaConstructorLineitem() throws Exception {
        String tableName = "lineitem";
        List<RexNode> customerConstraints = extractTableConstraints(tableName);

        // correct column definitions
        List<ColumnDefinition> correctColumnDefinitions = new ArrayList<>(customerConstraints.size());
//        "AND(<=($6, 0.10:DECIMAL(3, 2)), >=($6, 0.00:DECIMAL(3, 2)))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0.0, 0.1, -1L));
//        "AND(<=(1, $3), >=(7, $3))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 7, -1L));
//        "OR(=($9, 'F'), =($9, 'O'))"
        Set<Object> domain = new HashSet<>(Arrays. asList("O", "F"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 2L, -1L, domain, null, null, -1L));
//        "AND(<=(1, $1), <=($1, 20000))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 20000, -1L));
//        "AND(<=(1, $4), <=($4, 50))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 50, -1L));
//        "OR(=($8, 'A'), =($8, 'N'), =($8, 'R'))"
        Set<Object> domain1 = new HashSet<>(Arrays. asList("A", "N", "R"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 3L, -1L, domain1, null, null, -1L));
//        "OR(=($13, 'NONE'), =($13, 'COLLECT COD'), =($13, 'TAKE BACK RETURN'), =($13, 'DELIVER IN PERSON'))"
        Set<Object> domain2 = new HashSet<>(Arrays. asList("NONE", "COLLECT COD", "TAKE BACK RETURN", "DELIVER IN PERSON"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 4L, -1L, domain2, null, null, -1L));
//        "OR(=($14, 'AIR'), =($14, 'FOB'), =($14, 'MAIL'), =($14, 'RAIL'), =($14, 'SHIP'), =($14, 'TRUCK'), =($14, 'REG AIR'))"
        Set<Object> domain3 = new HashSet<>(Arrays. asList("AIR", "FOB", "MAIL", "RAIL", "SHIP", "TRUCK", "REG AIR"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 7L, -1L, domain3, null, null, -1L));
//        "AND(<=($7, 0.08:DECIMAL(3, 2)), >=($7, 0.00:DECIMAL(3, 2)))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0.00, 0.08, -1L));

        checkRelNodeColumnDefinitions(tableName, customerConstraints, correctColumnDefinitions, true);
    }
    ...
    public void testConstraintVisitorSchemaConstructorCustomer() throws Exception {
    ...
    public void testConstraintVisitorSchemaConstructorNation() throws Exception {
...
//        "AND(<=(0, $0), <=($0, 24))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0, 24, -1L));
//        "AND(<=(0, $2), >=(4, $2))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0, 4, -1L));
    ...
    public void testConstraintVisitorSchemaConstructorOrders() throws Exception {
        ...
        List<ColumnDefinition> correctColumnDefinitions = new ArrayList<>(customerConstraints.size());
//        "AND(<=($4, CAST('1998-12-31'):DATE NOT NULL), >=($4, CAST('1992-01-01'):DATE NOT NULL))"
        Comparable startDate = ConstraintVisitor.parseTimestampFromDateString("1992-01-01");
        Comparable endDate = ConstraintVisitor.parseTimestampFromDateString("1998-12-31");
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, startDate, endDate, -1L));
//        "AND(<=(1, $0), <=($0, 600000))"
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 600000, -1L));
//        "OR(=($5, '5-LOW'), =($5, '2-HIGH'), =($5, '1-URGENT'), =($5, '3-MEDIUM'), =($5, '4-NOT SPECIFIED'))"
        Set<Object> domain = new HashSet<>(Arrays. asList("1-URGENT", "2-HIGH", "3-MEDIUM", "4-NOT SPECIFIED", "5-LOW"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 5L, -1L, domain, null, null, -1L));
//        "OR(=($2, 'F'), =($2, 'O'), =($2, 'P'))"
        Set<Object> domain1 = new HashSet<>(Arrays. asList("F", "O", "P"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 3L, -1L, domain1, null, null, -1L));
//        "=(0, $7)"
        Set<Object> domain2 = new HashSet<>(Arrays. asList(0));
        correctColumnDefinitions.add(new ColumnDefinition(null, 1L, -1L, domain2, null, null, -1L));
    ...
    public void testConstraintVisitorSchemaConstructorPart() throws Exception {
...
//        AND(<=(1, $5), <=($5, 50))
    ...
    public void testConstraintVisitorSchemaConstructorPartsupp() throws Exception {
        ...
        List<ColumnDefinition> correctColumnDefinitions = new ArrayList<>(customerConstraints.size());
//        AND(<=(1, $2), <=($2, 9999))
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 9999, -1L));
//        AND(>=($3, 1.00:DECIMAL(3, 2)), <=($3, 1000.00:DECIMAL(6, 2)))
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1.00, 1000.00, -1L));
        checkRelNodeColumnDefinitions(tableName, customerConstraints, correctColumnDefinitions, true);
    }
    ...
    public void testConstraintVisitorSchemaConstructorRegion() throws Exception {
        ...
        List<ColumnDefinition> correctColumnDefinitions = new ArrayList<>(customerConstraints.size());
//        OR(=($1, 'ASIA'), =($1, 'AFRICA'), =($1, 'EUROPE'), =($1, 'AMERICA'), =($1, 'MIDDLE EAST'))
        Set<Object> domain = new HashSet<>(Arrays. asList("ASIA", "AFRICA", "EUROPE", "AMERICA", "MIDDLE EAST"));
        correctColumnDefinitions.add(new ColumnDefinition(null, 5L, -1L, domain, null, null, -1L));
//        AND(<=(0, $0), >=(4, $0))
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0, 4, -1L));
        checkRelNodeColumnDefinitions(tableName, customerConstraints, correctColumnDefinitions, true);
    ...
    public void testConstraintVisitorSchemaConstructorSupplier() throws Exception {
...
//        AND(<=(0, $3), <=($3, 24))
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 0, 24, -1L));
//        AND(<=(1, $0), <=($0, 1000))
        correctColumnDefinitions.add(new ColumnDefinition(null, -1L, -1L, null, 1, 1000, -1L));
        checkRelNodeColumnDefinitions(tableName, customerConstraints, correctColumnDefinitions, true);
    }
