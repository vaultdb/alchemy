...
public class TreeBuilderTpcHTest extends TpcHBaseTest {
  ...
  protected static final List<String> PLANS =
      ImmutableList.of(
          // 01
          ...
          "LogicalProject-DistributedOblivious, schema:(#0: s_acctbal DECIMAL(19, 0) Private,#1: s_name CHAR(25) Public,#2: n_name CHAR(25) Public,#3: p_partkey INTEGER Public,#4: p_mfgr CHAR(25) Public,#5: s_address VARCHAR(40) Private,#6: s_phone CHAR(15) Private,#7: s_comment VARCHAR(101) Private)\n"
              + "    LogicalSort-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey INTEGER Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey INTEGER Public,#15: r_regionkey INTEGER Public,#16: ps_partkey0 INTEGER Public,#17: min_cost DECIMAL(19, 0) Public)\n"
              + "        LogicalJoin-DistributedClear, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey INTEGER Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey INTEGER Public,#15: r_regionkey INTEGER Public,#16: ps_partkey0 INTEGER Public,#17: min_cost DECIMAL(19, 0) Public), Predicate: AND(=($16, $9), =($11, $17)), slice key: [#16: ps_partkey0 INTEGER Public, #9: ps_partkey INTEGER Public]\n"
              + "            LogicalJoin-LocalClearPartitioned, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey INTEGER Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey INTEGER Public,#15: r_regionkey INTEGER Public), Predicate: =($14, $15), slice key: [#14: n_regionkey INTEGER Public, #15: r_regionkey INTEGER Public]\n"
              + "                LogicalJoin-LocalClearPartitioned, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey INTEGER Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey INTEGER Public), Predicate: =($5, $12), slice key: [#5: s_nationkey INTEGER Public, #12: n_nationkey INTEGER Public]\n"
              + "                    LogicalJoin-LocalClearPartitioned, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey INTEGER Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public), Predicate: AND(=($0, $9), =($2, $10)), slice key: [#0: p_partkey INTEGER Public, #9: ps_partkey INTEGER Public, #2: s_suppkey INTEGER Public, #10: ps_suppkey INTEGER Public]\n"
              ...
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public)\n"
              ...
              + "            LogicalAggregate-DistributedClear, schema:(#0: ps_partkey INTEGER Public,#1: min_cost DECIMAL(19, 0) Public), slice key: [#0: ps_partkey INTEGER Public, #1: ps_supplycost DECIMAL(19, 0) Public]\n"
              + "                LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_supplycost DECIMAL(19, 0) Public)\n"
              + "                    LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey INTEGER Public,#5: n_nationkey INTEGER Public,#6: n_regionkey INTEGER Public,#7: r_regionkey INTEGER Public), Predicate: =($6, $7), slice key: [#6: n_regionkey INTEGER Public, #7: r_regionkey INTEGER Public]\n"
              + "                        LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey INTEGER Public,#5: n_nationkey INTEGER Public,#6: n_regionkey INTEGER Public), Predicate: =($4, $5), slice key: [#4: s_nationkey INTEGER Public, #5: n_nationkey INTEGER Public]\n"
              + "                            LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey INTEGER Public), Predicate: =($3, $1), slice key: [#3: s_suppkey INTEGER Public, #1: ps_suppkey INTEGER Public]\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public)\n"
              + "                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: ps_comment VARCHAR(199) Private)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public)\n"
              + "                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey INTEGER Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
              + "                            LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_regionkey INTEGER Public)\n"
              + "                                JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n"
              + "                        LogicalProject-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public)\n"
              + "                            LogicalFilter-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public,#1: r_name CHAR(25) Public)\n"
              + "                                LogicalProject-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public,#1: r_name CHAR(25) Public)\n"
          ...
          "LogicalSort-DistributedOblivious, schema:(#0: n_name CHAR(25) Public,#1: revenue DECIMAL(19, 0) Private)\n"
              ...
              + "                LogicalJoin-DistributedOblivious, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey INTEGER Public,#2: o_orderkey INTEGER Public,#3: o_custkey INTEGER Private,#4: l_orderkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: s_suppkey INTEGER Public,#9: s_nationkey INTEGER Public,#10: n_nationkey INTEGER Public,#11: n_name CHAR(25) Public,#12: n_regionkey INTEGER Public), Predicate: =($9, $10), slice key: [#9: s_nationkey INTEGER Public, #10: n_nationkey INTEGER Public]\n"
          ...
          // 07
          "LogicalSort-DistributedOblivious, schema:(#0: supp_nation CHAR(25) Public,#1: cust_nation CHAR(25) Public,#2: l_year BIGINT Private,#3: revenue DECIMAL(19, 0) Private)\n"
              + "    LogicalAggregate-DistributedOblivious, schema:(#0: supp_nation CHAR(25) Public,#1: cust_nation CHAR(25) Public,#2: l_year BIGINT Private,#3: revenue DECIMAL(19, 0) Private), slice key: [#0: supp_nation CHAR(25) Public, #1: cust_nation CHAR(25) Public]\n"
              + "        LogicalProject-DistributedOblivious, schema:(#0: supp_nation CHAR(25) Public,#1: cust_nation CHAR(25) Public,#2: l_year BIGINT Private,#3: volume DECIMAL(19, 0) Private)\n"
              + "            LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_year BIGINT Private,#5: l_suppkey INTEGER Private,#6: l_orderkey INTEGER Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private,#9: c_custkey INTEGER Public,#10: c_nationkey INTEGER Public,#11: n_nationkey INTEGER Public,#12: n_name CHAR(25) Public,#13: n_nationkey0 INTEGER Public,#14: n_name0 CHAR(25) Public), Predicate: AND(=($10, $13), OR(AND(=($12, 'EGYPT                    '), =($14, 'UNITED STATES            ')), AND(=($12, 'UNITED STATES            '), =($14, 'EGYPT                    ')))), slice key: [#10: c_nationkey INTEGER Public, #13: n_nationkey0 INTEGER Public]\n"
              + "                LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_year BIGINT Private,#5: l_suppkey INTEGER Private,#6: l_orderkey INTEGER Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private,#9: c_custkey INTEGER Public,#10: c_nationkey INTEGER Public,#11: n_nationkey INTEGER Public,#12: n_name CHAR(25) Public), Predicate: =($1, $11), slice key: [#1: s_nationkey INTEGER Public, #11: n_nationkey INTEGER Public]\n"
              + "                    LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_year BIGINT Private,#5: l_suppkey INTEGER Private,#6: l_orderkey INTEGER Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private,#9: c_custkey INTEGER Public,#10: c_nationkey INTEGER Public), Predicate: =($9, $8)\n"
              + "                        LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_year BIGINT Private,#5: l_suppkey INTEGER Private,#6: l_orderkey INTEGER Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private), Predicate: =($7, $6)\n"
              + "                            LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_year BIGINT Private,#5: l_suppkey INTEGER Private,#6: l_orderkey INTEGER Private), Predicate: =($0, $5)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public)\n"
              + "                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey INTEGER Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
              + "                                LogicalProject-LocalObliviousPartitioned, schema:(#0: l_extendedprice DECIMAL(19, 0) Private,#1: l_discount DECIMAL(19, 0) Private,#2: l_year BIGINT Private,#3: l_suppkey INTEGER Private,#4: l_orderkey INTEGER Private)\n"
              + "                                    LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_shipdate DATE Private)\n"
              + "                                        LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_shipdate DATE Private)\n"
              + "                                            JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                            LogicalProject-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private)\n"
              + "                                JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey INTEGER Public)\n"
              + "                            JdbcTableScan-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
          ...
          //  08
          "LogicalProject-DistributedOblivious, schema:(#0: o_year BIGINT Private,#1: mkt_share DECIMAL(19, 0) Private)\n"
              + "    LogicalSort-DistributedOblivious, schema:(#0: o_year BIGINT Private,#1: $f1 DECIMAL(19, 0) Private,#2: $f2 DECIMAL(19, 0) Private)\n"
              + "        LogicalAggregate-DistributedOblivious, schema:(#0: o_year BIGINT Private,#1: $f1 DECIMAL(19, 0) Private,#2: $f2 DECIMAL(19, 0) Private)\n"
              + "            LogicalProject-DistributedOblivious, schema:(#0: o_year BIGINT Private,#1: $f1 DECIMAL(19, 0) Private,#2: volume DECIMAL(19, 0) Private)\n"
              + "                LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: o_orderkey INTEGER Public,#9: o_custkey INTEGER Private,#10: o_year BIGINT Private,#11: c_custkey INTEGER Public,#12: c_nationkey INTEGER Public,#13: n_nationkey INTEGER Public,#14: n_regionkey INTEGER Public,#15: n_nationkey0 INTEGER Public,#16: nation_check BOOLEAN Public,#17: r_regionkey INTEGER Public), Predicate: =($14, $17), slice key: [#14: n_regionkey INTEGER Public, #17: r_regionkey INTEGER Public]\n"
              + "                    LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: o_orderkey INTEGER Public,#9: o_custkey INTEGER Private,#10: o_year BIGINT Private,#11: c_custkey INTEGER Public,#12: c_nationkey INTEGER Public,#13: n_nationkey INTEGER Public,#14: n_regionkey INTEGER Public,#15: n_nationkey0 INTEGER Public,#16: nation_check BOOLEAN Public), Predicate: =($2, $15), slice key: [#2: s_nationkey INTEGER Public, #15: n_nationkey0 INTEGER Public]\n"
              + "                        LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: o_orderkey INTEGER Public,#9: o_custkey INTEGER Private,#10: o_year BIGINT Private,#11: c_custkey INTEGER Public,#12: c_nationkey INTEGER Public,#13: n_nationkey INTEGER Public,#14: n_regionkey INTEGER Public), Predicate: =($12, $13), slice key: [#12: c_nationkey INTEGER Public, #13: n_nationkey INTEGER Public]\n"
              + "                            LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: o_orderkey INTEGER Public,#9: o_custkey INTEGER Private,#10: o_year BIGINT Private,#11: c_custkey INTEGER Public,#12: c_nationkey INTEGER Public), Predicate: =($9, $11)\n"
              + "                                LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: o_orderkey INTEGER Public,#9: o_custkey INTEGER Private,#10: o_year BIGINT Private), Predicate: =($3, $8)\n"
              + "                                    LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private), Predicate: AND(=($0, $4), =($1, $5))\n"
              + "                                        LogicalJoin-LocalClearPartitioned, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public), Predicate: true\n"
              + "                                            LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public)\n"
              + "                                                LogicalFilter-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_type VARCHAR(25) Public)\n"
              + "                                                    LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_type VARCHAR(25) Public)\n"
              + "                                                        JdbcTableScan-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public,#2: p_mfgr CHAR(25) Public,#3: p_brand CHAR(10) Public,#4: p_type VARCHAR(25) Public,#5: p_size INTEGER Public,#6: p_container CHAR(10) Public,#7: p_retailprice DECIMAL(19, 0) Public,#8: p_comment VARCHAR(23) Public)\n"
              + "                                            LogicalProject-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public)\n"
              + "                                                JdbcTableScan-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey INTEGER Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
              + "                                        LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_extendedprice DECIMAL(19, 0) Private,#4: l_discount DECIMAL(19, 0) Private)\n"
              + "                                            JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                                    LogicalProject-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_year BIGINT Private)\n"
              + "                                        LogicalFilter-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderdate DATE Private)\n"
              + "                                            LogicalProject-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderdate DATE Private)\n"
              + "                                                JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey INTEGER Public)\n"
              ...
              + "                            LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_regionkey INTEGER Public)\n"
              + "                                JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n"
              + "                        LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: nation_check BOOLEAN Public)\n"
              + "                            JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n"
              + "                    LogicalProject-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public)\n"
              + "                        LogicalFilter-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public,#1: r_name CHAR(25) Public)\n"
              + "                            LogicalProject-LocalClearReplicated, schema:(#0: r_regionkey INTEGER Public,#1: r_name CHAR(25) Public)\n"
          ...
          //  09
          "LogicalSort-DistributedOblivious, schema:(#0: nation CHAR(25) Public,#1: o_year BIGINT Private,#2: sum_profit DECIMAL(19, 0) Private)\n"
              + "    LogicalAggregate-DistributedOblivious, schema:(#0: nation CHAR(25) Public,#1: o_year BIGINT Private,#2: sum_profit DECIMAL(19, 0) Private), slice key: [#0: nation CHAR(25) Public]\n"
              + "        LogicalProject-DistributedOblivious, schema:(#0: nation CHAR(25) Public,#1: o_year BIGINT Private,#2: amount DECIMAL(19, 0) Private)\n"
              + "            LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_quantity DECIMAL(19, 0) Private,#7: l_extendedprice DECIMAL(19, 0) Private,#8: l_discount DECIMAL(19, 0) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: o_year BIGINT Private,#13: o_orderkey INTEGER Public,#14: n_nationkey INTEGER Public,#15: n_name CHAR(25) Public), Predicate: =($2, $14), slice key: [#2: s_nationkey INTEGER Public, #14: n_nationkey INTEGER Public]\n"
              + "                LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_quantity DECIMAL(19, 0) Private,#7: l_extendedprice DECIMAL(19, 0) Private,#8: l_discount DECIMAL(19, 0) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: o_year BIGINT Private,#13: o_orderkey INTEGER Public), Predicate: =($13, $3)\n"
              + "                    LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_quantity DECIMAL(19, 0) Private,#7: l_extendedprice DECIMAL(19, 0) Private,#8: l_discount DECIMAL(19, 0) Private,#9: ps_partkey INTEGER Public,#10: ps_suppkey INTEGER Public,#11: ps_supplycost DECIMAL(19, 0) Public), Predicate: AND(=($10, $5), =($9, $4))\n"
              + "                        LogicalJoin-DistributedOblivious, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public,#3: l_orderkey INTEGER Private,#4: l_partkey INTEGER Private,#5: l_suppkey INTEGER Private,#6: l_quantity DECIMAL(19, 0) Private,#7: l_extendedprice DECIMAL(19, 0) Private,#8: l_discount DECIMAL(19, 0) Private), Predicate: AND(=($1, $5), =($0, $4))\n"
              + "                            LogicalJoin-LocalClearPartitioned, schema:(#0: p_partkey INTEGER Public,#1: s_suppkey INTEGER Public,#2: s_nationkey INTEGER Public), Predicate: true\n"
              + "                                LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public)\n"
              + "                                    LogicalFilter-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public)\n"
              + "                                        LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public)\n"
              + "                                            JdbcTableScan-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public,#2: p_mfgr CHAR(25) Public,#3: p_brand CHAR(10) Public,#4: p_type VARCHAR(25) Public,#5: p_size INTEGER Public,#6: p_container CHAR(10) Public,#7: p_retailprice DECIMAL(19, 0) Public,#8: p_comment VARCHAR(23) Public)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey INTEGER Public)\n"
              + "                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey INTEGER Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
              + "                            LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_quantity DECIMAL(19, 0) Private,#4: l_extendedprice DECIMAL(19, 0) Private,#5: l_discount DECIMAL(19, 0) Private)\n"
              + "                                JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_supplycost DECIMAL(19, 0) Public)\n"
              + "                            JdbcTableScan-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: ps_comment VARCHAR(199) Private)\n"
              + "                    LogicalProject-LocalClearPartitioned, schema:(#0: o_year BIGINT Private,#1: o_orderkey INTEGER Public)\n"
              + "                        JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public)\n"
              + "                    JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n",

          //  10
          "LogicalProject-DistributedOblivious, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: revenue DECIMAL(19, 0) Private,#3: c_acctbal DECIMAL(19, 0) Private,#4: n_name CHAR(25) Public,#5: c_address VARCHAR(40) Private,#6: c_phone CHAR(15) Private,#7: c_comment VARCHAR(117) Private)\n"
              + "    LogicalSort-DistributedOblivious, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_acctbal DECIMAL(19, 0) Private,#3: c_phone CHAR(15) Private,#4: n_name CHAR(25) Public,#5: c_address VARCHAR(40) Private,#6: c_comment VARCHAR(117) Private,#7: revenue DECIMAL(19, 0) Private)\n"
              + "        LogicalAggregate-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_acctbal DECIMAL(19, 0) Private,#3: c_phone CHAR(15) Private,#4: n_name CHAR(25) Public,#5: c_address VARCHAR(40) Private,#6: c_comment VARCHAR(117) Private,#7: revenue DECIMAL(19, 0) Private), slice key: [#0: c_custkey INTEGER Public, #4: n_name CHAR(25) Public]\n"
              + "            LogicalProject-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_acctbal DECIMAL(19, 0) Private,#3: c_phone CHAR(15) Private,#4: n_name CHAR(25) Public,#5: c_address VARCHAR(40) Private,#6: c_comment VARCHAR(117) Private,#7: $f7 DECIMAL(19, 0) Private)\n"
              + "                LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_comment VARCHAR(117) Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private,#9: l_orderkey INTEGER Private,#10: l_extendedprice DECIMAL(19, 0) Private,#11: l_discount DECIMAL(19, 0) Private,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public), Predicate: =($3, $12), slice key: [#3: c_nationkey INTEGER Public, #12: n_nationkey INTEGER Public]\n"
              + "                    LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_comment VARCHAR(117) Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private,#9: l_orderkey INTEGER Private,#10: l_extendedprice DECIMAL(19, 0) Private,#11: l_discount DECIMAL(19, 0) Private), Predicate: =($9, $7)\n"
              + "                        LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_comment VARCHAR(117) Private,#7: o_orderkey INTEGER Public,#8: o_custkey INTEGER Private), Predicate: =($0, $8)\n"
              + "                            LogicalProject-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_comment VARCHAR(117) Private)\n"
              + "                                JdbcTableScan-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
              + "                            LogicalProject-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private)\n"
              + "                                LogicalFilter-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderdate DATE Private)\n"
              + "                                    LogicalProject-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderdate DATE Private)\n"
              + "                                        JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                        LogicalProject-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private)\n"
              + "                            LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_returnflag CHAR(1) Private)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_returnflag CHAR(1) Private)\n"
              + "                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                    LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public)\n"
              + "                        JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n",
          ...
          "LogicalProject-DistributedOblivious, schema:(#0: ps_partkey INTEGER Public,#1: val DECIMAL(19, 0) Private)\n"
              ...
              + "                LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: $f1 DECIMAL(19, 0) Private)\n"
              + "                    LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: s_suppkey INTEGER Public,#5: s_nationkey INTEGER Public,#6: n_nationkey INTEGER Public), Predicate: =($5, $6), slice key: [#5: s_nationkey INTEGER Public, #6: n_nationkey INTEGER Public]\n"
              + "                        LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: s_suppkey INTEGER Public,#5: s_nationkey INTEGER Public), Predicate: =($1, $4), slice key: [#1: ps_suppkey INTEGER Public, #4: s_suppkey INTEGER Public]\n"
              ...
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: $f0 DECIMAL(19, 0) Private)\n"
              + "                            LogicalJoin-LocalClearPartitioned, schema:(#0: ps_suppkey INTEGER Public,#1: ps_availqty INTEGER Private,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey INTEGER Public,#5: n_nationkey INTEGER Public), Predicate: =($4, $5), slice key: [#4: s_nationkey INTEGER Public, #5: n_nationkey INTEGER Public]\n"
              + "                                LogicalJoin-LocalClearPartitioned, schema:(#0: ps_suppkey INTEGER Public,#1: ps_availqty INTEGER Private,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey INTEGER Public), Predicate: =($0, $3), slice key: [#0: ps_suppkey INTEGER Public, #3: s_suppkey INTEGER Public]\n"
          ...
          //  15
          "LogicalProject-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_phone CHAR(15) Private,#4: total_revenue DECIMAL(19, 0) Private)\n"
              + "    LogicalSort-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_phone CHAR(15) Private,#4: l_suppkey INTEGER Private,#5: EXPR$1 DECIMAL(19, 0) Private,#6: EXPR$0 DECIMAL(19, 0) Private)\n"
              + "        LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_phone CHAR(15) Private,#4: l_suppkey INTEGER Private,#5: EXPR$1 DECIMAL(19, 0) Private,#6: EXPR$0 DECIMAL(19, 0) Private), Predicate: =($5, $6)\n"
              + "            LogicalJoin-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_phone CHAR(15) Private,#4: l_suppkey INTEGER Private,#5: EXPR$1 DECIMAL(19, 0) Private), Predicate: =($0, $4)\n"
              + "                LogicalProject-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_phone CHAR(15) Private)\n"
              + "                    JdbcTableScan-LocalClearPartitioned, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey INTEGER Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
              + "                LogicalAggregate-DistributedOblivious, schema:(#0: l_suppkey INTEGER Private,#1: EXPR$1 DECIMAL(19, 0) Private)\n"
              + "                    LogicalProject-LocalObliviousPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: $f1 DECIMAL(19, 0) Private)\n"
              + "                        LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
              + "                            LogicalProject-LocalClearPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
              + "                                JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "            LogicalAggregate-DistributedOblivious, schema:(#0: EXPR$0 DECIMAL(19, 0) Private)\n"
              + "                LogicalProject-DistributedOblivious, schema:(#0: EXPR$1 DECIMAL(19, 0) Private)\n"
              + "                    LogicalAggregate-DistributedOblivious, schema:(#0: l_suppkey INTEGER Private,#1: EXPR$1 DECIMAL(19, 0) Private)\n"
              + "                        LogicalProject-LocalObliviousPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: $f1 DECIMAL(19, 0) Private)\n"
              + "                            LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: l_suppkey INTEGER Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
          ...
          //  18
          "LogicalSort-DistributedOblivious, schema:(#0: c_name VARCHAR(25) Private,#1: c_custkey INTEGER Public,#2: o_orderkey INTEGER Public,#3: o_orderdate DATE Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: EXPR$5 DECIMAL(19, 0) Private)\n"
              + "    LogicalAggregate-LocalObliviousPartitioned, schema:(#0: c_name VARCHAR(25) Private,#1: c_custkey INTEGER Public,#2: o_orderkey INTEGER Public,#3: o_orderdate DATE Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: EXPR$5 DECIMAL(19, 0) Private), slice key: [#1: c_custkey INTEGER Public, #2: o_orderkey INTEGER Public]\n"
              + "        LogicalProject-LocalObliviousPartitioned, schema:(#0: c_name VARCHAR(25) Private,#1: c_custkey INTEGER Public,#2: o_orderkey INTEGER Public,#3: o_orderdate DATE Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: l_quantity DECIMAL(19, 0) Private)\n"
              + "            LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: o_orderkey INTEGER Public,#3: o_custkey INTEGER Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: o_orderdate DATE Private,#6: l_orderkey INTEGER Private,#7: l_quantity DECIMAL(19, 0) Private,#8: l_orderkey0 INTEGER Private), Predicate: =($2, $8)\n"
              + "                LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: o_orderkey INTEGER Public,#3: o_custkey INTEGER Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: o_orderdate DATE Private,#6: l_orderkey INTEGER Private,#7: l_quantity DECIMAL(19, 0) Private), Predicate: =($2, $6)\n"
              + "                    LogicalJoin-LocalObliviousPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: o_orderkey INTEGER Public,#3: o_custkey INTEGER Private,#4: o_totalprice DECIMAL(19, 0) Private,#5: o_orderdate DATE Private), Predicate: =($0, $3)\n"
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private)\n"
              + "                            JdbcTableScan-LocalClearPartitioned, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey INTEGER Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
              + "                        LogicalProject-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_totalprice DECIMAL(19, 0) Private,#3: o_orderdate DATE Private)\n"
              + "                            JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                    LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_quantity DECIMAL(19, 0) Private)\n"
              + "                        JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                LogicalProject-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private)\n"
              + "                    LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: $f1 DECIMAL(19, 0) Private)\n"
              + "                        LogicalAggregate-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: $f1 DECIMAL(19, 0) Private)\n"
              + "                            LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_quantity DECIMAL(19, 0) Private)\n"
              + "                                JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n",
          ...
          "LogicalAggregate-DistributedOblivious, schema:(#0: revenue DECIMAL(19, 0) Private)\n"
              + "    LogicalProject-LocalObliviousPartitioned, schema:(#0: $f0 DECIMAL(19, 0) Private)\n"
              + "        LogicalJoin-LocalObliviousPartitioned, schema:(#0: l_partkey INTEGER Private,#1: l_quantity DECIMAL(19, 0) Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_shipinstruct CHAR(25) Private,#5: l_shipmode CHAR(10) Private,#6: p_partkey INTEGER Public,#7: p_brand CHAR(10) Public,#8: p_size INTEGER Public,#9: p_container CHAR(10) Public), Predicate: OR(AND(=($6, $0), =($7, 'Brand#41  '), OR(=($9, 'SM CASE'), =($9, 'SM BOX'), =($9, 'SM PACK'), =($9, 'SM PKG')), >=($1, 2), <=($1, +(2, 10)), >=($8, 1), <=($8, 5), OR(=($5, 'AIR'), =($5, 'AIR REG')), =($4, 'DELIVER IN PERSON        ')), AND(=($6, $0), =($7, 'Brand#13  '), OR(=($9, 'MED BAG'), =($9, 'MED BOX'), =($9, 'MED PKG'), =($9, 'MED PACK')), >=($1, 14), <=($1, +(14, 10)), >=($8, 1), <=($8, 10), OR(=($5, 'AIR'), =($5, 'AIR REG')), =($4, 'DELIVER IN PERSON        ')), AND(=($6, $0), =($7, 'Brand#55  '), OR(=($9, 'LG CASE'), =($9, 'LG BOX'), =($9, 'LG PACK'), =($9, 'LG PKG')), >=($1, 23), <=($1, +(23, 10)), >=($8, 1), <=($8, 15), OR(=($5, 'AIR'), =($5, 'AIR REG')), =($4, 'DELIVER IN PERSON        ')))\n"
              + "            LogicalProject-LocalClearPartitioned, schema:(#0: l_partkey INTEGER Private,#1: l_quantity DECIMAL(19, 0) Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private,#4: l_shipinstruct CHAR(25) Private,#5: l_shipmode CHAR(10) Private)\n"
              + "                JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "            LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_brand CHAR(10) Public,#2: p_size INTEGER Public,#3: p_container CHAR(10) Public)\n"
              + "                JdbcTableScan-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public,#2: p_mfgr CHAR(25) Public,#3: p_brand CHAR(10) Public,#4: p_type VARCHAR(25) Public,#5: p_size INTEGER Public,#6: p_container CHAR(10) Public,#7: p_retailprice DECIMAL(19, 0) Public,#8: p_comment VARCHAR(23) Public)\n",

          //  20
              "LogicalProject-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: s_address VARCHAR(40) Private)\n"
              + "    LogicalSort-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: s_address VARCHAR(40) Private,#2: s_nationkey INTEGER Public,#3: n_nationkey INTEGER Public)\n"
              ...
              + "                            LogicalJoin-DistributedOblivious, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: inventory DECIMAL(19, 1) Private,#3: ps_suppkey INTEGER Public,#4: ps_partkey INTEGER Public,#5: ps_availqty INTEGER Private), Predicate: AND(=($0, $4), =($1, $3), >($5, $2))\n"
              + "                                LogicalProject-DistributedOblivious, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: inventory DECIMAL(19, 1) Private)\n"
              + "                                    LogicalAggregate-DistributedOblivious, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: $f2 DECIMAL(19, 0) Private)\n"
              + "                                        LogicalProject-LocalObliviousPartitioned, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_quantity DECIMAL(19, 0) Private)\n"
              + "                                            LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_quantity DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
              + "                                                LogicalProject-LocalClearPartitioned, schema:(#0: l_partkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_quantity DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
              + "                                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                                LogicalProject-LocalClearPartitioned, schema:(#0: ps_suppkey INTEGER Public,#1: ps_partkey INTEGER Public,#2: ps_availqty INTEGER Private), slice key: [#1: ps_partkey INTEGER Public]\n"
              + "                                    LogicalJoin-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: p_partkey INTEGER Public), Predicate: =($0, $3), slice key: [#0: ps_partkey INTEGER Public, #3: p_partkey INTEGER Public]\n"
              + "                                        LogicalProject-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private)\n"
              + "                                            JdbcTableScan-LocalClearPartitioned, schema:(#0: ps_partkey INTEGER Public,#1: ps_suppkey INTEGER Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: ps_comment VARCHAR(199) Private)\n"
              + "                                        LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public)\n"
              + "                                            LogicalFilter-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public)\n"
              + "                                                LogicalProject-LocalClearReplicated, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public)\n"
          ...
          //  21
          "LogicalSort-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: numwait BIGINT Public)\n"
              + "    LogicalAggregate-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: numwait BIGINT Public), slice key: [#0: s_name CHAR(25) Public]\n"
              + "        LogicalProject-DistributedOblivious, schema:(#0: s_name CHAR(25) Public)\n"
              + "            LogicalJoin-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: l_orderkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_suppkey0 INTEGER Private,#4: l_orderkey0 INTEGER Private), Predicate: AND(=($1, $4), =($2, $3))\n"
              + "                LogicalProject-DistributedOblivious, schema:(#0: s_name CHAR(25) Public,#1: l_orderkey INTEGER Private,#2: l_suppkey INTEGER Private)\n"
              + "                    LogicalSort-DistributedOblivious, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_nationkey INTEGER Public,#3: l_suppkey INTEGER Private,#4: l_orderkey INTEGER Private,#5: o_orderkey INTEGER Public,#6: n_nationkey INTEGER Public)\n"
              ...
              + "                                                            LogicalFilter-LocalObliviousPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_commitdate DATE Private,#3: l_receiptdate DATE Private)\n"
              + "                                                                LogicalProject-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_suppkey INTEGER Private,#2: l_commitdate DATE Private,#3: l_receiptdate DATE Private)\n"
              + "                                                                    JdbcTableScan-LocalClearPartitioned, schema:(#0: l_orderkey INTEGER Private,#1: l_partkey INTEGER Private,#2: l_suppkey INTEGER Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
              + "                                LogicalProject-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public)\n"
              + "                                    LogicalFilter-LocalObliviousPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_orderstatus CHAR(1) Private)\n"
              + "                                        LogicalProject-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_orderstatus CHAR(1) Private)\n"
              + "                                            JdbcTableScan-LocalClearPartitioned, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey INTEGER Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
              + "                            LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public)\n"
              + "                                LogicalFilter-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public)\n"
              + "                                    LogicalProject-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public)\n"
              + "                                        JdbcTableScan-LocalClearReplicated, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey INTEGER Public,#3: n_comment VARCHAR(152) Public)\n"
              + "                LogicalFilter-DistributedOblivious, schema:(#0: l_suppkey INTEGER Private,#1: l_orderkey INTEGER Private)\n"
  ...
  public void testQuery05() throws Exception {
    // TODO: push down access to replicated tables, make s_nationkey join on replicated nation key
    // rather than doing it in MPC
  ...
  public void testQuery16() throws Exception {
    ...
    // TODO: use heuristics to push down the locally-runnable join in experiments
