...
public class TreeBuilderTpcHTest extends TpcHBaseTest {
	  ...
	  protected void setUp() throws Exception {
		...
		protected static final List<String> PLANS = ImmutableList.of(
				// 01
				"LogicalSort-Secure, schema:(#0: l_returnflag CHAR(1) Private,#1: l_linestatus CHAR(1) Private,#2: sum_qty DECIMAL(19, 0) Private,#3: sum_base_price DECIMAL(19, 0) Private,#4: sum_disc_price DECIMAL(19, 0) Private,#5: sum_charge DECIMAL(19, 0) Private,#6: avg_qty DECIMAL(19, 0) Private,#7: avg_price DECIMAL(19, 0) Private,#8: avg_disc DECIMAL(19, 0) Private,#9: count_order BIGINT Private)\n"
				+ "    LogicalAggregate-Secure, schema:(#0: l_returnflag CHAR(1) Private,#1: l_linestatus CHAR(1) Private,#2: sum_qty DECIMAL(19, 0) Private,#3: sum_base_price DECIMAL(19, 0) Private,#4: sum_disc_price DECIMAL(19, 0) Private,#5: sum_charge DECIMAL(19, 0) Private,#6: avg_qty DECIMAL(19, 0) Private,#7: avg_price DECIMAL(19, 0) Private,#8: avg_disc DECIMAL(19, 0) Private,#9: count_order BIGINT Private)\n"
      		  + "        LogicalProject-Plain, schema:(#0: l_returnflag CHAR(1) Private,#1: l_linestatus CHAR(1) Private,#2: l_quantity DECIMAL(19, 0) Private,#3: l_extendedprice DECIMAL(19, 0) Private,#4: $f4 DECIMAL(19, 0) Private,#5: $f5 DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private)\n"
      		  + "            LogicalFilter-Plain, schema:(#0: l_quantity DECIMAL(19, 0) Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_tax DECIMAL(19, 0) Private,#4: l_returnflag CHAR(1) Private,#5: l_linestatus CHAR(1) Private,#6: l_shipdate DATE Private)\n"
      		  + "                LogicalProject-Plain, schema:(#0: l_quantity DECIMAL(19, 0) Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_tax DECIMAL(19, 0) Private,#4: l_returnflag CHAR(1) Private,#5: l_linestatus CHAR(1) Private,#6: l_shipdate DATE Private)\n"
      		...
      		"LogicalProject-Secure, schema:(#0: s_acctbal DECIMAL(19, 0) Private,#1: s_name CHAR(25) Public,#2: n_name CHAR(25) Public,#3: p_partkey INTEGER Public,#4: p_mfgr CHAR(25) Public,#5: s_address VARCHAR(40) Private,#6: s_phone CHAR(15) Private,#7: s_comment VARCHAR(101) Private)\n"
          		  + "    LogicalSort-Secure, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey BIGINT Public,#10: ps_suppkey BIGINT Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey BIGINT Public,#15: r_regionkey INTEGER Public,#16: ps_partkey0 BIGINT Public,#17: min_cost DECIMAL(19, 0) Public)\n"
          		  + "        LogicalJoin-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey BIGINT Public,#10: ps_suppkey BIGINT Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey BIGINT Public,#15: r_regionkey INTEGER Public,#16: ps_partkey0 BIGINT Public,#17: min_cost DECIMAL(19, 0) Public), slice key: [#16: ps_partkey0 BIGINT Public, #9: ps_partkey BIGINT Public]\n"
          		  + "            LogicalJoin-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey BIGINT Public,#10: ps_suppkey BIGINT Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey BIGINT Public,#15: r_regionkey INTEGER Public)\n"
          		  + "                LogicalJoin-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey BIGINT Public,#10: ps_suppkey BIGINT Public,#11: ps_supplycost DECIMAL(19, 0) Public,#12: n_nationkey INTEGER Public,#13: n_name CHAR(25) Public,#14: n_regionkey BIGINT Public)\n"
          		  + "                    LogicalJoin-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private,#9: ps_partkey BIGINT Public,#10: ps_suppkey BIGINT Public,#11: ps_supplycost DECIMAL(19, 0) Public)\n"
          		  + "                        LogicalJoin-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: s_suppkey INTEGER Public,#3: s_name CHAR(25) Public,#4: s_address VARCHAR(40) Private,#5: s_nationkey BIGINT Public,#6: s_phone CHAR(15) Private,#7: s_acctbal DECIMAL(19, 0) Private,#8: s_comment VARCHAR(101) Private)\n"
          		  + "                            LogicalProject-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public)\n"
          		  + "                                LogicalFilter-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: p_type VARCHAR(25) Public,#3: p_size INTEGER Public)\n"
          		  + "                                    LogicalProject-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_mfgr CHAR(25) Public,#2: p_type VARCHAR(25) Public,#3: p_size INTEGER Public)\n"
          		  ...
          		  + "                    LogicalProject-Plain, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey BIGINT Public)\n"
          		  ...
          		  + "            LogicalAggregate-Plain, schema:(#0: ps_partkey BIGINT Public,#1: min_cost DECIMAL(19, 0) Public), slice key: [#0: ps_partkey BIGINT Public, #1: ps_supplycost DECIMAL(19, 0) Public]\n"
          		  + "                LogicalProject-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_supplycost DECIMAL(19, 0) Public)\n"
          		  + "                    LogicalJoin-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_suppkey BIGINT Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey BIGINT Public,#5: n_nationkey INTEGER Public,#6: n_regionkey BIGINT Public,#7: r_regionkey INTEGER Public)\n"
          		  + "                        LogicalJoin-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_suppkey BIGINT Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey BIGINT Public,#5: n_nationkey INTEGER Public,#6: n_regionkey BIGINT Public)\n"
          		  + "                            LogicalJoin-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_suppkey BIGINT Public,#2: ps_supplycost DECIMAL(19, 0) Public,#3: s_suppkey INTEGER Public,#4: s_nationkey BIGINT Public)\n"
          		  + "                                LogicalProject-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_suppkey BIGINT Public,#2: ps_supplycost DECIMAL(19, 0) Public)\n"
          		  + "                                    JdbcTableScan-Plain, schema:(#0: ps_partkey BIGINT Public,#1: ps_suppkey BIGINT Public,#2: ps_availqty INTEGER Private,#3: ps_supplycost DECIMAL(19, 0) Public,#4: ps_comment VARCHAR(199) Private)\n"
          		  ...
          		  // 03
          		  "LogicalProject-Secure, schema:(#0: l_orderkey BIGINT Private,#1: revenue DECIMAL(19, 0) Private,#2: o_orderdate DATE Private,#3: o_shippriority INTEGER Private)\n"
          				 + "    LogicalSort-Secure, schema:(#0: l_orderkey BIGINT Private,#1: o_orderdate DATE Private,#2: o_shippriority INTEGER Private,#3: revenue DECIMAL(19, 0) Private)\n"
          				 + "        LogicalAggregate-Secure, schema:(#0: l_orderkey BIGINT Private,#1: o_orderdate DATE Private,#2: o_shippriority INTEGER Private,#3: revenue DECIMAL(19, 0) Private)\n"
          				 + "            LogicalProject-Secure, schema:(#0: l_orderkey BIGINT Private,#1: o_orderdate DATE Private,#2: o_shippriority INTEGER Private,#3: $f3 DECIMAL(19, 0) Private)\n"
          				 + "                LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: o_orderkey INTEGER Public,#2: o_custkey BIGINT Private,#3: o_orderdate DATE Private,#4: o_shippriority INTEGER Private,#5: l_orderkey BIGINT Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private)\n"
          				 + "                    LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: o_orderkey INTEGER Public,#2: o_custkey BIGINT Private,#3: o_orderdate DATE Private,#4: o_shippriority INTEGER Private)\n"
          				 + "                        LogicalProject-Plain, schema:(#0: c_custkey INTEGER Public)\n"
          				 + "                            LogicalFilter-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_mktsegment CHAR(10) Private)\n"
          				 + "                                LogicalProject-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_mktsegment CHAR(10) Private)\n"
          				 ...
          				 + "                        LogicalFilter-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderdate DATE Private,#3: o_shippriority INTEGER Private)\n"
          				 + "                            LogicalProject-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderdate DATE Private,#3: o_shippriority INTEGER Private)\n"
          				 ...
          				 + "                        LogicalFilter-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
          				 + "                            LogicalProject-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
          				 + "                                JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n",
          				 ...
          				 "LogicalSort-Secure, schema:(#0: o_orderpriority CHAR(15) Private,#1: order_count BIGINT Private)\n"
          					...
          					// 05
          						 "LogicalSort-Secure, schema:(#0: n_name CHAR(25) Public,#1: revenue DECIMAL(19, 0) Private)\n"
          								 ...
          								 + "        LogicalProject-Secure, schema:(#0: n_name CHAR(25) Public,#1: $f1 DECIMAL(19, 0) Private)\n"
          								 + "            LogicalJoin-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey BIGINT Public,#2: o_orderkey INTEGER Public,#3: o_custkey BIGINT Private,#4: l_orderkey BIGINT Private,#5: l_suppkey BIGINT Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: s_suppkey INTEGER Public,#9: s_nationkey BIGINT Public,#10: n_nationkey INTEGER Public,#11: n_name CHAR(25) Public,#12: n_regionkey BIGINT Public,#13: r_regionkey INTEGER Public)\n"
          								 + "                LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey BIGINT Public,#2: o_orderkey INTEGER Public,#3: o_custkey BIGINT Private,#4: l_orderkey BIGINT Private,#5: l_suppkey BIGINT Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: s_suppkey INTEGER Public,#9: s_nationkey BIGINT Public,#10: n_nationkey INTEGER Public,#11: n_name CHAR(25) Public,#12: n_regionkey BIGINT Public)\n"
          								 + "                    LogicalJoin-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey BIGINT Public,#2: o_orderkey INTEGER Public,#3: o_custkey BIGINT Private,#4: l_orderkey BIGINT Private,#5: l_suppkey BIGINT Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private,#8: s_suppkey INTEGER Public,#9: s_nationkey BIGINT Public), slice key: [#1: c_nationkey BIGINT Public, #9: s_nationkey BIGINT Public]\n"
          								 + "                        LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey BIGINT Public,#2: o_orderkey INTEGER Public,#3: o_custkey BIGINT Private,#4: l_orderkey BIGINT Private,#5: l_suppkey BIGINT Private,#6: l_extendedprice DECIMAL(19, 0) Private,#7: l_discount DECIMAL(19, 0) Private)\n"
          								 + "                            LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_nationkey BIGINT Public,#2: o_orderkey INTEGER Public,#3: o_custkey BIGINT Private)\n"
          								 ...
          								 + "                                            JdbcTableScan-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
          								 + "                            LogicalProject-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_suppkey BIGINT Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: l_discount DECIMAL(19, 0) Private)\n"
          								 + "                                JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
          								 + "                        LogicalProject-Plain, schema:(#0: s_suppkey INTEGER Public,#1: s_nationkey BIGINT Public)\n"
          								 + "                            JdbcTableScan-Plain, schema:(#0: s_suppkey INTEGER Public,#1: s_name CHAR(25) Public,#2: s_address VARCHAR(40) Private,#3: s_nationkey BIGINT Public,#4: s_phone CHAR(15) Private,#5: s_acctbal DECIMAL(19, 0) Private,#6: s_comment VARCHAR(101) Private)\n"
          								 + "                    LogicalProject-Plain, schema:(#0: n_nationkey INTEGER Public,#1: n_name CHAR(25) Public,#2: n_regionkey BIGINT Public)\n"
          						...
          						// 06
          								 "LogicalAggregate-Secure, schema:(#0: revenue DECIMAL(19, 0) Private)\n"
          										 ...
          										 + "        LogicalFilter-Plain, schema:(#0: l_quantity DECIMAL(19, 0) Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
          										 + "            LogicalProject-Plain, schema:(#0: l_quantity DECIMAL(19, 0) Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
          										 + "                JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n",
...
+ "    LogicalAggregate-Secure, schema:(#0: l_shipmode CHAR(10) Private,#1: high_line_count INTEGER Private,#2: low_line_count INTEGER Private)\n"
+ "        LogicalProject-Secure, schema:(#0: l_shipmode CHAR(10) Private,#1: $f1 INTEGER Private,#2: $f2 INTEGER Private)\n"
+ "            LogicalJoin-Secure, schema:(#0: o_orderkey INTEGER Public,#1: o_orderpriority CHAR(15) Private,#2: l_orderkey BIGINT Private,#3: l_shipmode CHAR(10) Private)\n"
+ "                LogicalProject-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_orderpriority CHAR(15) Private)\n"
+ "                    JdbcTableScan-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
+ "                LogicalProject-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_shipmode CHAR(10) Private)\n"
+ "                    LogicalFilter-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_shipdate DATE Private,#2: l_commitdate DATE Private,#3: l_receiptdate DATE Private,#4: l_shipmode CHAR(10) Private)\n"
+ "                        LogicalProject-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_shipdate DATE Private,#2: l_commitdate DATE Private,#3: l_receiptdate DATE Private,#4: l_shipmode CHAR(10) Private)\n"
+ "                            JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
,

          											     //  13
"LogicalSort-Secure, schema:(#0: c_count BIGINT Public,#1: custdist BIGINT Public)\n"
+ "    LogicalAggregate-Secure, schema:(#0: c_count BIGINT Public,#1: custdist BIGINT Public)\n"
+ "        LogicalProject-Secure, schema:(#0: c_count BIGINT Public), slice key: [#0: c_count BIGINT Public]\n"
+ "            LogicalAggregate-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_count BIGINT Public), slice key: [#0: c_custkey INTEGER Public, #1: o_orderkey INTEGER Public]\n"
+ "                LogicalProject-Secure, schema:(#0: c_custkey INTEGER Public,#1: o_orderkey INTEGER Public)\n"
+ "                    LogicalJoin-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_custkey0 BIGINT Public,#2: o_custkey BIGINT Private,#3: o_orderkey INTEGER Public)\n"
+ "                        LogicalProject-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_custkey0 BIGINT Public)\n"
+ "                            JdbcTableScan-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
+ "                        LogicalProject-Plain, schema:(#0: o_custkey BIGINT Private,#1: o_orderkey INTEGER Public)\n"
+ "                            LogicalFilter-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_comment VARCHAR(79) Private)\n"
+ "                                LogicalProject-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_comment VARCHAR(79) Private)\n"
+ "                                    JdbcTableScan-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
,

          											     //  14
"LogicalProject-Secure, schema:(#0: promo_revenue DECIMAL(19, 2) Private)\n"
+ "    LogicalAggregate-Secure, schema:(#0: $f0 DECIMAL(19, 0) Private,#1: $f1 DECIMAL(19, 0) Private)\n"
+ "        LogicalProject-Plain, schema:(#0: $f0 DECIMAL(19, 0) Private,#1: $f1 DECIMAL(19, 0) Private)\n"
+ "            LogicalJoin-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: p_partkey INTEGER Public,#4: p_type VARCHAR(25) Public)\n"
+ "                LogicalProject-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private)\n"
+ "                    LogicalFilter-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
+ "                        LogicalProject-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_extendedprice DECIMAL(19, 0) Private,#2: l_discount DECIMAL(19, 0) Private,#3: l_shipdate DATE Private)\n"
+ "                            JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
+ "                LogicalProject-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_type VARCHAR(25) Public)\n"
+ "                    JdbcTableScan-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public,#2: p_mfgr CHAR(25) Public,#3: p_brand CHAR(10) Public,#4: p_type VARCHAR(25) Public,#5: p_size INTEGER Public,#6: p_container CHAR(10) Public,#7: p_retailprice DECIMAL(19, 0) Public,#8: p_comment VARCHAR(23) Public)\n"
,
...
,
          											     ...
          											     //  17
 "LogicalProject-Secure, schema:(#0: avg_yearly DECIMAL(19, 0) Private)\n"
+ "    LogicalAggregate-Secure, schema:(#0: $f0 DECIMAL(19, 0) Private)\n"
+ "        LogicalProject-Secure, schema:(#0: l_extendedprice DECIMAL(19, 0) Private)\n"
+ "            LogicalJoin-Secure, schema:(#0: l_partkey BIGINT Private,#1: l_quantity DECIMAL(19, 0) Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: p_partkey INTEGER Public,#4: l_partkey0 BIGINT Private,#5: avg_l2_q DECIMAL(19, 1) Private)\n"
+ "                LogicalJoin-Secure, schema:(#0: l_partkey BIGINT Private,#1: l_quantity DECIMAL(19, 0) Private,#2: l_extendedprice DECIMAL(19, 0) Private,#3: p_partkey INTEGER Public)\n"
+ "                    LogicalProject-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_quantity DECIMAL(19, 0) Private,#2: l_extendedprice DECIMAL(19, 0) Private)\n"
+ "                        JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
+ "                    LogicalProject-Plain, schema:(#0: p_partkey INTEGER Public)\n"
+ "                        LogicalFilter-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_brand CHAR(10) Public,#2: p_container CHAR(10) Public)\n"
+ "                            LogicalProject-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_brand CHAR(10) Public,#2: p_container CHAR(10) Public)\n"
+ "                                JdbcTableScan-Plain, schema:(#0: p_partkey INTEGER Public,#1: p_name VARCHAR(55) Public,#2: p_mfgr CHAR(25) Public,#3: p_brand CHAR(10) Public,#4: p_type VARCHAR(25) Public,#5: p_size INTEGER Public,#6: p_container CHAR(10) Public,#7: p_retailprice DECIMAL(19, 0) Public,#8: p_comment VARCHAR(23) Public)\n"
+ "                LogicalProject-Secure, schema:(#0: l_partkey BIGINT Private,#1: avg_l2_q DECIMAL(19, 1) Private)\n"
+ "                    LogicalAggregate-Secure, schema:(#0: l_partkey BIGINT Private,#1: $f1 DECIMAL(19, 0) Private)\n"
+ "                        LogicalProject-Plain, schema:(#0: l_partkey BIGINT Private,#1: l_quantity DECIMAL(19, 0) Private)\n"
+ "                            JdbcTableScan-Plain, schema:(#0: l_orderkey BIGINT Private,#1: l_partkey BIGINT Private,#2: l_suppkey BIGINT Private,#3: l_linenumber INTEGER Private,#4: l_quantity DECIMAL(19, 0) Private,#5: l_extendedprice DECIMAL(19, 0) Private,#6: l_discount DECIMAL(19, 0) Private,#7: l_tax DECIMAL(19, 0) Private,#8: l_returnflag CHAR(1) Private,#9: l_linestatus CHAR(1) Private,#10: l_shipdate DATE Private,#11: l_commitdate DATE Private,#12: l_receiptdate DATE Private,#13: l_shipinstruct CHAR(25) Private,#14: l_shipmode CHAR(10) Private,#15: l_comment VARCHAR(44) Private)\n"
,
...
+ "            LogicalFilter-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private,#8: EXPR$0 DECIMAL(19, 0) Private,#9: $f0 BOOLEAN Public)\n"
+ "                LogicalCorrelate-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private,#8: EXPR$0 DECIMAL(19, 0) Private,#9: $f0 BOOLEAN Public)\n"
+ "                    LogicalJoin-Secure, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private,#8: EXPR$0 DECIMAL(19, 0) Private)\n"
+ "                        JdbcTableScan-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
+ "                        LogicalAggregate-Secure, schema:(#0: EXPR$0 DECIMAL(19, 0) Private)\n"
+ "                            LogicalProject-Plain, schema:(#0: c_acctbal DECIMAL(19, 0) Private)\n"
+ "                                LogicalFilter-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
+ "                                    JdbcTableScan-Plain, schema:(#0: c_custkey INTEGER Public,#1: c_name VARCHAR(25) Private,#2: c_address VARCHAR(40) Private,#3: c_nationkey BIGINT Public,#4: c_phone CHAR(15) Private,#5: c_acctbal DECIMAL(19, 0) Private,#6: c_mktsegment CHAR(10) Private,#7: c_comment VARCHAR(117) Private)\n"
+ "                    LogicalAggregate-Secure, schema:(#0: $f0 BOOLEAN Public)\n"
+ "                        LogicalProject-Plain, schema:(#0: $f0 BOOLEAN Public)\n"
+ "                            LogicalFilter-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
+ "                                JdbcTableScan-Plain, schema:(#0: o_orderkey INTEGER Public,#1: o_custkey BIGINT Private,#2: o_orderstatus CHAR(1) Private,#3: o_totalprice DECIMAL(19, 0) Private,#4: o_orderdate DATE Private,#5: o_orderpriority CHAR(15) Private,#6: o_clerk CHAR(15) Private,#7: o_shippriority INTEGER Private,#8: o_comment VARCHAR(79) Private)\n"
